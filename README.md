...
端口：443
默认UUID：b2849eb4-5426-4cc4-8143-04356aea498a
vmess额外id：0
加密：none
传输协议：ws
伪装类型：none
伪装域名：xxx-xxx.koyeb.app
路径：/b2849eb4-5426-4cc4-8143-04356aea498a-vless
...
```bash
{
    ...
    "remote_port": 443,
    "password": [
        "b2849eb4-5426-4cc4-8143-04356aea498a"
    ],
    "websocket": {
        "enabled": true,
